    ...
    def post(self):
            ...
            return (
                {
                    ...
                    "data": {
                        "status": "ratelimited",
                        "message": "Ты сдаешь флаги слишком быстро",
                    },
                },
                429,
            )
        ...
        if not solves:
            ...
            if status == "correct" or status is True:
                ...
                return {
                    "success": True,
                    "data": {"status": "correct", "message": "Верно"},
                }
            elif status == "partial":
                ...
                return {
                    "success": True,
                    "data": {"status": "partial", "message": "Верно"},
                }
                ...
                if max_tries:
                    ...
                    return {
                        "success": True,
                        "data": {"status": "incorrect", "message": "Неверно"},
                    }
        ...
        # Challenge already solved
            ...
            return {
                ...
                "data": {
                    ...
                    "message": f"Ты уже решил задание",
                },
            }
